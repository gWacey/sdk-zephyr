...
static void tac5112_emul_reg_set(struct tac5112_emul_data *data, uint8_t val)
{
	...
	if ((data->cur_page == TAC5112_REG_SW_RESET.page) &&
	    (data->cur_addr == TAC5112_REG_SW_RESET.addr) &&
	    ((val & TAC5112_SW_RESET_BIT) != 0U)) {
...
#define TAC5112_EMUL_DEFINE(n)                                                                   \
	...
	EMUL_DT_INST_DEFINE(n, tac5112_emul_init, &tac5112_emul_data_##n,                         \
			     &tac5112_emul_cfg_##n, &tac5112_emul_bus_api, NULL)
